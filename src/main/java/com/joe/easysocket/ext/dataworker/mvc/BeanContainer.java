...
/**
 * bean容器，需要可以扫描生成带有{@link com.joe.easysocket.ext.dataworker.mvc.container.Provider}注解的bean
 * <p>
 * 如果使用系统自带的MVC容器，那么还需要bean容器可以扫描生成带有{@link com.joe.easysocket.ext.dataworker.mvc.resource.annotation.Path}注解的bean
 * <p>
