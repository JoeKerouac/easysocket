package com.joe.easysocket.common;

import com.joe.collection.ByteArray;
import com.joe.easysocket.data.Datagram;
import com.joe.easysocket.exception.DataOutOfMemory;
import com.joe.easysocket.exception.IllegalRequestException;
...
public class DatagramUtil {
    ...
    // 数据报数据除去请求头的最大长度
    private static final int MAX_LENGTH = Datagram.MAX_LENGTH - 16;
    ...
    public static Datagram build(byte[] body, byte type, byte version) throws DataOutOfMemory {
        ...
        // 缓存
        ByteArray buffer = new ByteArray(16 + dataLen);
        // 一个字节的版本号
